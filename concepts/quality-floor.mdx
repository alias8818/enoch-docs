...
For paper-positive rows, the publication lane is automatic once deterministic gates pass. Enoch pushes generated artifacts as written after evidence, provenance, claim-ledger, strict-audit, import-ledger, and public-index checks succeed. Do not treat human editorial approval, taste review, or agent opinion as a normal gate between writer output and corpus push.
...
After those gates pass, the artifact is pushed as generated. Human readers can still critique or replicate it later, but that critique is not a required pre-push editorial stage.
