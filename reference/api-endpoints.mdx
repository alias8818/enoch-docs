...
Rewrites the paper draft artifacts for the given paper using the configured writer. If `paper_evidence_sync_enabled` is `true`, the control plane syncs evidence from the worker before rewriting.
