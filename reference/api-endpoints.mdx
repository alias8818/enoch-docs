---
title: "Enoch API endpoints: operator reference"
description: "Operator reference for the Enoch FastAPI surface: health, control-plane queues, dispatch, paper review, wake gate, Enoch Core, and dashboards."
