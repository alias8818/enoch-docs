...
Enoch addresses those problems with explicit state, authenticated APIs, worker preflight, process tracking, telemetry thresholds, evidence bundles, claim ledgers, and packaging/provenance checks.
