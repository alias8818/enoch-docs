...
![Sanitized Enoch dashboard status view showing dispatch safety, queue counts, source freshness, and active lane state](/images/dashboard-status-blocked.png)

This screenshot is a sanitized internal capture. It hides the bearer token and replaces private identifiers with demo values.
