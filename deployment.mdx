...
<Warning>
  Do not publish generated artifacts until corpus import, index building, packaging/provenance scans, and human review are complete. The packaging/provenance checks scan for placeholder citations, missing provenance, and missing evidence artifacts; the release snapshot still listed several corpus-publication steps as pending.
</Warning>
