...
The source for this docs website lives in [`alias8818/enoch-docs`](https://github.com/alias8818/enoch-docs). The application code lives in
...
<CardGroup cols={2}>
  <Card title="Documentation website" icon="book-open" href="https://github.com/alias8818/enoch-docs">
    This repo is the Mintlify docs source. It explains the system, deployment path, API surface, and provenance rules.
  </Card>
